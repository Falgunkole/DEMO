    ...
    <div className="pt-32 pb-20 bg-slate-950 min-h-screen">
      <div className="max-w-2xl mx-auto px-4">
        <div className="glass-card p-8 rounded-3xl border border-white/10">
          ...
          <p className="text-slate-300 mb-6">Share your requirement and our team will contact you with a quote and appointment options. The owner dashboard is notified instantly.</p>
